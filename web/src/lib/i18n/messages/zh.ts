...
export const zh = {
  ...
  meta: {
    ...
    pricingTitle: "价格 — KindleDict",
    pricingDescription:
      "KindleDict 面向读者、单本书生成，以及作者/出版方的价格方案。",
  ...
  pricingPage: {
    ...
    title: "先为读者设计的简单定价",
    subtitle:
      "先用示例和 1 次免费章节确认效果；只有当你真的要做整本书流程时才付费。",
    reassurance:
      "读者方案不是订阅制。按书购买后，你可以继续为这一本到书反复生成和调整词典。",
    plans: [
      {
        name: "示例 + 1 次免费章节",
        price: "免费",
        body:
          "官方示例可不限次体验；另外你还可以用自己的 EPUB 免费生成 1 个章节，先验证质量再决定是否购买。",
        bullets: [
          "官方示例不限次体验",
          "你自己的 EPUB 可免费生成 1 个章节",
          "适合首次试用与效果验证",
        ],
        cta: "免费试用",
        href: "/app?sample=1",
      },
      {
        ...
        price: "$3.99 / 本",
        body:
          "解锁 1 本书的完整流程，包括多章节与整书生成，只要文件仍在当前系统上限内即可继续使用。",
        bullets: [
          "同一本书可无限次重新生成",
          "支持多章节与整书生成",
          "适合个人读者",
      ...
      },
      {
        ...
        price: "$49 起",
        body:
          "面向你拥有或出版的作品，支持商业交付、版权边界更清晰，也可配合上线流程做人工支持。",
        bullets: [
          "支持商业用途与交付",
          "可做品牌化伴侣词典",
          "支持批量或托管式交付",
    ...
    notes: [
      {
        title: "免费用于验证，不是无限薅羊毛",
        body:
          "你可以先用真实章节确认效果，但持续生成属于付费能力，避免试用路径被滥用。",
      },
      {
        title: "按书定价更贴合真实需求",
        body:
          "多数读者想解决的是“这一本书怎么查词更顺”，而不是为一个长期订阅买单。",
      },
      {
        title: "商业版本质上是另一种产品",
        body:
          "作者与出版方通常还会涉及版权、审核、包装与交付，这和个人阅读版不是同一工作量。",
      },
    ],
    faqTitle: "价格常见问题",
    faqs: [
      {
        q: "买了 1 本书后，具体解锁什么？",
        a: "你会解锁这一本到书的持续生成能力，包括重生成词条、多章节处理，以及在当前系统上限内的整书生成。",
      },
      {
        q: "需要订阅吗？",
        a: "目前读者方案不需要。当前默认是按书付费。",
      },
      {
        q: "一次购买可以用于多本书吗？",
        a: "当前读者方案不支持。每次购买对应 1 个书籍项目，这样成本和使用量更匹配。",
      },
      {
        q: "为什么作者/出版方方案贵很多？",
        a: "因为它覆盖商业用途，以及更多协作、审核和交付要求，不只是个人阅读工具。",
      },
    ],
    ctaTitle: "先试免费章节，觉得值再升级",
    ctaBody:
      "这个产品最适合先上手体验。你可以先跑示例，或用自己的第一章测试，再决定是否解锁整本书。",
    ctaPrimary: "开始免费试用",
    ctaSecondary: "去生成词典",
  },
  builder: {
  ...
  auth: {
    ...
    signInSubtitle: "登录以继续使用 KindleDict。",
    registerSubtitle: "使用邮箱和密码注册，密码至少 8 位。",
    email: "邮箱",
    password: "密码",
    ...
    noAccount: "还没有账户？",
    hasAccount: "已有账户？",
    registerSuccess: "账户已创建。若需邮箱验证，请先确认邮件后再登录。",
    genericError: "出了点问题，请重试。",
  },
  dashboard: {
    metaTitle: "控制台 — KindleDict",
    metaDescription: "管理 KindleDict 访问权限、账单与账户设置。",
    badge: "控制台",
    title: "控制台",
    subtitle: "查看访问权限、账单与账户设置。",
    signedInKicker: "已登录",
    paidAccess: "已付费",
    freeTrialOnly: "仅免费试用",
    signedInSuccess: "登录成功。",
    checkoutSuccess:
      "支付已完成。若页面仍显示免费试用，请等待几秒让 webhook 同步后刷新。",
    checkoutAlreadyActive: "该账户已有付费权限。",
    signInRequired: "请先登录再发起结账。",
    authNotConfigured: "尚未配置 Supabase 认证，无法将结账绑定到账户。",
    statusLabel: "状态",
    statusPaid: "已付费",
    statusFree: "仅免费试用",
    planLabel: "方案",
    planNone: "尚未购买",
    paidBody: "该账户可超出免费章节限制继续生成。",
    freeBody: "升级后可解锁持续生成，付款会自动绑定到此邮箱。",
    openBuilder: "打开生成器",
    viewPricing: "查看价格",
    signOut: "退出登录",
    buyAccess: "购买单本书权限",
    contactForAccess: "联系获取权限",
  },
} as const;
