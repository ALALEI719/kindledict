...
export const en = {
  ...
  auth: {
    ...
    registerKicker: "New here",
    welcomeBack: "Welcome back",
    createAccountTitle: "Create your account",
    signInSubtitle: "Sign in to continue using KindleDict.",
    registerSubtitle: "Use email and password. Password must be at least 8 characters.",
    email: "Email",
    password: "Password",
    ...
    registerSuccess:
      "Account created. If email confirmation is required, confirm once, then sign in.",
    genericError: "Something went wrong. Please try again.",
  },
  dashboard: {
    metaTitle: "Dashboard — KindleDict",
    metaDescription: "Manage your KindleDict access, billing, and account settings.",
    badge: "Dashboard",
    title: "Dashboard",
    subtitle: "Track access, billing, and account settings.",
    signedInKicker: "Signed in",
    paidAccess: "Paid access",
    freeTrialOnly: "Free trial only",
    signedInSuccess: "Signed in successfully.",
    checkoutSuccess:
      "Payment completed. If this page still shows free trial only, wait a few seconds for the webhook to sync, then refresh.",
    checkoutAlreadyActive: "This account already has paid access.",
    signInRequired: "Please sign in before starting checkout.",
    authNotConfigured:
      "Supabase auth is not configured yet, so checkout cannot be tied to an account.",
    statusLabel: "Status",
    statusPaid: "Paid",
    statusFree: "Free trial only",
    planLabel: "Plan",
    planNone: "Not purchased yet",
    paidBody: "This account can generate beyond the free chapter limit.",
    freeBody:
      "Upgrade this account to unlock continued generation. Your payment will be matched back to this email automatically.",
    openBuilder: "Open builder",
    viewPricing: "View pricing",
    signOut: "Sign out",
    buyAccess: "Buy single-book access",
